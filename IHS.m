...
iteracion=50000;% Máximo número de iteraciones
parmin=0.35;
parmax=0.99;
bwmin=0.0001;
bwmax=0.1;
...
for g=1:iteracion
 g
 par=parmin+((parmax-parmin)/iteracion)*g;
     
 for i=1:var
          c=log(bwmin/bwmax)/iteracion;
          bw=bwmax*exp(c*g);
...
display(fobj)
 ...
 cel = ['A', num2str(celda)] ;
  xlswrite('g1_Mahdavi.xlsx',tonoFinal,1,cel);
